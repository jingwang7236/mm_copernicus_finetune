...
custom_imports = dict(
    imports=['copernicusbench', 'copernicusbench.models.head', 'copernicusbench.hooks'],
...
# custom_hooks = [
#     dict(
#         type='OlmoEarthFTStrategyHook',
#         total_epoch=50,
#         unfrozen_epoch_rate=0.8
#     )
# ]

work_dir="save/pastis_seg_finetune"